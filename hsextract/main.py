...
async def _extract(
    ...
    await list_and_extract(
        input_path, output_path, input_base_url, output_base_url, user_metadata_filename
    )
...
def extract(
    input_path: str,
    output_path: str,
    input_base_url: Annotated[
        str, typer.Argument()
    ] = "https://hydroshare.org/resource/resource_id/data/contents/",
    output_base_url: Annotated[
        str, typer.Argument()
    ] = "https://hydroshare.org/resource/resource_id/extracted_metadata",
